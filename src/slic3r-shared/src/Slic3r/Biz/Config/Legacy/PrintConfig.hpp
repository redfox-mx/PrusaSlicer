...
PRINT_CONFIG_CLASS_DEFINE(
    ...
    ((ConfigOptionFloat,                object_extrusion_ratio))
    // Ironing options
...
PRINT_CONFIG_CLASS_DEFINE(
    ...
    ((ConfigOptionFloat,               filament_change_time))
    ...
    ((ConfigOptionInt,                 filament_ramming_temperature_delta))
    ((ConfigOptionFloat,               filament_ramming_initial_delay))
    ...
    ((ConfigOptionBool,                enable_pressure_advance_during_ramming))
    ((ConfigOptionFloat,               parking_pos_retraction))
    ((ConfigOptionBool,                remaining_times))
    ((ConfigOptionBool,                stuck_filament_detection))
...
PRINT_CONFIG_CLASS_DERIVED_DEFINE(
    ...
    ((ConfigOptionFloatOrPercent,     first_layer_solid_infill_speed))
